...
{
    public partial class frmManteContrato : XtraForm
    {
        ...
        public void setValues()
        {
            ...
            dtFechaCuota.EditValue = Obe.cntc_sfecha_cuota.ToString().Substring(0, 10) == "01/01/0001" ? (DateTime?)null : Obe.cntc_sfecha_cuota;
        ...
        private void SetSave()
        {
            ...
            try
            {
                ...
                if (txtSerie.Text != "D003" && txtSerie.Text != "0002" && txtSerie.Text != "0000" && txtSerie.Text != "0001") 
                {
                    oBase = txtSerie;
                    throw new ArgumentException("La serie del Contrato debe ser D003 , 0002, 0000, 0001");
                }
                if (Convert.ToInt32(lkpNombreIEC.EditValue) == 0)
                {
                    oBase = lkpNombreIEC;
                ...
                if (String.IsNullOrEmpty(dtFechaNacContratante.Text) || dtFechaNacContratante.Text == "01/01/0001")
                {
                ...
                if (String.IsNullOrEmpty(dtFechaNacRepresentante.Text) || dtFechaNacRepresentante.Text == "01/01/0001")
                {
                ...
                if (dtFechaCuota.DateTime == null || dtFechaCuota.Text == "" || dtFechaCuota.Text == "01/01/0001")
                {
