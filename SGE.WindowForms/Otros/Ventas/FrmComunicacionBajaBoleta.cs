...
namespace SGI.WindowsForm.Otros.Ventas
{
    ...
    public partial class FrmComunicacionBajaBoleta : DevExpress.XtraEditors.XtraForm
    {
        ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmComunicacionBajaBoleta));
        public FrmComunicacionBajaBoleta()
        {
        ...
        private void SetSave()
        {
            ...
            {                
                ...
                obj.bovc_descripcion_motivo_baja = txtDescripcionMotivo.Text;                                                
                
                if (Status == BSMaintenanceStatus.CreateNew)
                {
                    new BVentas().ActualizarMotivoBajaCabeceraBoleta(obj);
