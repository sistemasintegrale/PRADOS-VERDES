...
{
    public partial class rptEstadoGGPP_Mant : DevExpress.XtraReports.UI.XtraReport
    {
        
        int cont = 0;


        public rptEstadoGGPP_Mant()
        {
            InitializeComponent();
        }
        List<EEstadoGanPerCtasFuncion> ListaCD;
        List<EEstadoGanPerFuncion> ListaSD;
        public void cargar(List<EEstadoGanPerCtasFuncion> ListaDetalle, List<EEstadoGanPerFuncion> Lista)
        {
