...
{
    public partial class rptBalance_Mant : DevExpress.XtraReports.UI.XtraReport
    {
        
        int cont = 0;


        public rptBalance_Mant()
        {
            InitializeComponent();
        }
        ...
        public void cargar(List<EBalanceCtas> ListaCD, List<EBalance> ListaSD)
        {
            this.ListaCD = ListaCD;
            this.ListaSD = ListaSD;
            xrlblEmpresa.Text = Valores.strNombreEmpresa;
            xrlblTitulo1.Text = "BALANCE GENERAL AL MES DE ";
