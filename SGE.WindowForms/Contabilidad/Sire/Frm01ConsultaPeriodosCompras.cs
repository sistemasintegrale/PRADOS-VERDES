...
{
    public partial class Frm01ConsultaPeriodosCompras : DevExpress.XtraEditors.XtraForm
    {
        ...
        public Frm01ConsultaPeriodosCompras() { InitializeComponent(); }
        ...
        public async Task Cargar()
        {
            ...
            var lstSireDb = new BContabilidad().SireListar().Where(x => x.operacion == "COMPRA");
