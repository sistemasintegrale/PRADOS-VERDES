...
{
    public partial class rptVerificacionStockRequerimientoMateriales : DevExpress.XtraReports.UI.XtraReport
    {
        public rptVerificacionStockRequerimientoMateriales()
        {
            InitializeComponent();
        }
        public void cargar(string strTitulo1, List<ERequerimientoMaterialesDetalle> lstDetalle, ERequerimientoMateriales Obe)
        {
            ...
            new XRBinding("Text", lstDetalle, "rqmd_cantidad_pedida", "{0:N2}")});

            lblCAprobada.DataBindings.AddRange(new XRBinding[] {
            new XRBinding("Text", lstDetalle, "rqmd_cantidad_aprobada", "{0:N2}")});

            lblStock.DataBindings.AddRange(new XRBinding[] {
            new XRBinding("Text", lstDetalle, "Stock", "{0:N2}")});

            lblDiferencia.DataBindings.AddRange(new XRBinding[] {
            new XRBinding("Text", lstDetalle, "StockDiferencia", "")});
