...
{
    public partial class rptMayorCCostoMesConDet : DevExpress.XtraReports.UI.XtraReport
    {
        public rptMayorCCostoMesConDet()
        {
            InitializeComponent();
        }
        public void Cargar(List<EVoucherContableDet> Lista,string Mes,string CuentaI,string CuentaF,string CCostoI,
            string CCostoF, string type, string codigo, decimal mtoTotalSaldoAnteriorSol,
            decimal mtoTotalSaldoAnteriorDol, decimal mtoTotalSaldoActualSol, decimal mtoTotalSaldoActualDol)
        {
            ...
            GroupHeader2.GroupFields.AddRange(new GroupField[] { new GroupField("strCodCCosto") });
